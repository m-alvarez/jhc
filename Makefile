...
pkgdatadir = $(datadir)/jhc
pkgincludedir = $(includedir)/jhc
pkglibdir = $(libdir)/jhc
pkglibexecdir = $(libexecdir)/jhc
...
bin_PROGRAMS = jhc$(EXEEXT)
DIST_COMMON = $(am__configure_deps) $(dist_man_MANS) \
	$(srcdir)/Makefile.am $(srcdir)/Makefile.in \
	$(srcdir)/jhc.spec.in $(srcdir)/library_deps.make \
	$(top_srcdir)/configure $(top_srcdir)/docs/building.mkd.in \
	$(top_srcdir)/src/Version/Config.hs.in \
	$(top_srcdir)/src/cbits/config.h.in \
	$(top_srcdir)/src/data/targets.ini.in \
	$(top_srcdir)/src/hs_src_config.h.in ChangeLog \
	ac-macros/compile ac-macros/config.guess ac-macros/config.sub \
	ac-macros/install-sh ac-macros/missing
subdir = .
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
am__aclocal_m4_deps = $(top_srcdir)/ac-macros/ac_define_dir.m4 \
	$(top_srcdir)/ac-macros/acincludepackage.m4 \
	$(top_srcdir)/ac-macros/ghc_macros.m4 \
	$(top_srcdir)/ac-macros/jwm_hs_macros.m4 \
...
CONFIG_CLEAN_FILES = jhc.spec src/hs_src_config.h \
	src/Version/Config.hs docs/building.mkd src/cbits/config.h \
	src/data/targets.ini
CONFIG_CLEAN_VPATH_FILES =
am__installdirs = "$(DESTDIR)$(bindir)" "$(DESTDIR)$(man1dir)"
PROGRAMS = $(bin_PROGRAMS)
am__objects_1 =
am__objects_2 = $(am__objects_1)
am_jhc_OBJECTS = $(am__objects_1) $(am__objects_2) $(am__objects_1) \
	$(am__objects_1)
jhc_OBJECTS = $(am_jhc_OBJECTS)
jhc_LDADD = $(LDADD)
DEFAULT_INCLUDES = -I.
depcomp =
am__depfiles_maybe =
...
ACLOCAL = ${SHELL} /home/user/haskell/jhcM/ac-macros/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /home/user/haskell/jhcM/ac-macros/missing --run autoconf
AUTOHEADER = ${SHELL} /home/user/haskell/jhcM/ac-macros/missing --run autoheader
AUTOMAKE = ${SHELL} /home/user/haskell/jhcM/ac-macros/missing --run automake-1.11
AWK = mawk
...
DEFS = -DPACKAGE_NAME=\"jhc\" -DPACKAGE_TARNAME=\"jhc\" -DPACKAGE_VERSION=\"0.8.2\" -DPACKAGE_STRING=\"jhc\ 0.8.2\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"jhc\" -DVERSION=\"0.8.2\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DLIBDIR=\"/home/user/haskell/jhcM/install/lib\" -DDATADIR=\"/home/user/haskell/jhcM/install/share\" -DJLIBPATH=\"/home/user/haskell/jhcM/install/share/jhc-0.8\" -DJETCPATH=\"/home/user/haskell/jhcM/install/etc/jhc-0.8\"
DRIFTGHC = /home/user/.cabal/bin/DrIFT
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EGREP = /bin/grep -E
EXEEXT = 
EXTRA_PACKAGES = 
GHCFLAGS = -hide-all-packages -package base -package zlib -package mtl -package array -package binary -package utf8-string -package bytestring -package syb -package fgl -package containers -package HsSyck -package process -package directory -package filepath -package unix -package random -package old-time -package pretty -package regex-compat -package readline
GHCINC = -i  -i./compat/haskell98 -i$(srcdir)/drift_processed \
	 -i$(srcdir)/src -i$(builddir)/src -odir $(builddir)/src -hidir $(builddir)/src \
	 -I$(srcdir)/src -I$(builddir)/src

GREP = /bin/grep
HAS_FOLDABLE_TUPLE = 0
HAS_FOLDABLE_TUPLE3 = 0
HAS_FUNCTOR_TUPLE = 1
HAS_FUNCTOR_TUPLE3 = 0
HAS_MONOID_DOC = 1
HAS_SHOW_IDENTITY = 0
HAS_TRAVERSABLE_INTMAP = 1
...
JETCPATH = /home/user/haskell/jhcM/install/etc/jhc-0.8
JLIBPATH = /home/user/haskell/jhcM/install/share/jhc-0.8
LDFLAGS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/user/haskell/jhcM/ac-macros/missing --run makeinfo
MINGW = i386-mingw32-gcc
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = jhc
PACKAGE_BUGREPORT = 
PACKAGE_NAME = jhc
PACKAGE_STRING = jhc 0.8.2
PACKAGE_TARNAME = jhc
PACKAGE_URL = 
...
VERSION_MINOR = 8
VERSION_PATCH = 2
abs_builddir = /home/user/haskell/jhcM
abs_srcdir = /home/user/haskell/jhcM
abs_top_builddir = /home/user/haskell/jhcM
abs_top_srcdir = /home/user/haskell/jhcM
ac_ct_CC = gcc
am__leading_dot = .
...
install_sh = ${SHELL} /home/user/haskell/jhcM/ac-macros/install-sh
...
pdfdir = ${docdir}
prefix = /home/user/haskell/jhcM/install
...
GHCOPTS = $(HSOPTS) -O -hide-all-packages -package base -package zlib -package mtl -package array -package binary -package utf8-string -package bytestring -package syb -package fgl -package containers -package HsSyck -package process -package directory -package filepath -package unix -package random -package old-time -package pretty -package regex-compat -package readline $(GHCDEBUGOPTS) $(GHCINC) $(GHCLANG)
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/library_deps.make $(am__configure_deps)
	@for dep in $?; do \
...
$(am__aclocal_m4_deps):
jhc.spec: $(top_builddir)/config.status $(srcdir)/jhc.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
src/hs_src_config.h: $(top_builddir)/config.status $(top_srcdir)/src/hs_src_config.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
src/Version/Config.hs: $(top_builddir)/config.status $(top_srcdir)/src/Version/Config.hs.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/building.mkd: $(top_builddir)/config.status $(top_srcdir)/docs/building.mkd.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
src/cbits/config.h: $(top_builddir)/config.status $(top_srcdir)/src/cbits/config.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
src/data/targets.ini: $(top_builddir)/config.status $(top_srcdir)/src/data/targets.ini.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
.PHONY: all all-am all-local am--refresh check check-TESTS check-am \
	clean clean-binPROGRAMS clean-generic clean-local dist \
...
install-data-hook: $(JHC_LIBS) $(JHC_EXT_LIBS)
	$(INSTALL) -d $(DESTDIR)$(datadir)/jhc-0.8
	$(INSTALL) -d $(DESTDIR)$(datadir)/jhc-0.8/include
	$(INSTALL) -d $(DESTDIR)$(sysconfdir)/jhc-0.8
	for lib in $(JHC_LIBS) $(JHC_EXT_LIBS); do \
		test -f "$$lib" && $(INSTALL_DATA) $$lib $(DESTDIR)$(datadir)/jhc-0.8 ; \
		test -f "$(srcdir)/$$lib" && $(INSTALL_DATA) "$(srcdir)/$$lib" $(DESTDIR)$(datadir)/jhc-0.8 ; \
	done
	$(INSTALL_DATA) "$(srcdir)/rts/HsFFI.h" $(DESTDIR)$(datadir)/jhc-0.8/include
	$(INSTALL_DATA) "$(srcdir)/src/data/targets.ini" $(DESTDIR)$(sysconfdir)/jhc-0.8

uninstall-hook:
	rm -f -- "$(DESTDIR)$(bindir)/jhci$(EXTEXT)"
	for lib in $(JHC_LIBS) $(JHC_EXT_LIBS); do \
		rm -f -- "$(DESTDIR)$(datadir)/jhc-0.8/$$lib" ; \
	done
	rm -f -- "$(DESTDIR)$(datadir)/jhc-0.8/include/HsFFI.h"
	rm -f -- "$(DESTDIR)$(sysconfdir)/jhc-0.8/targets.ini"
	-rmdir $(DESTDIR)$(datadir)/jhc-0.8/include
	-rmdir $(DESTDIR)$(datadir)/jhc-0.8
	-rmdir $(DESTDIR)$(sysconfdir)/jhc-0.8
